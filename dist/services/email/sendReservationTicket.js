...
const reservationSchema = zod_1.z.object({
    ...
    unit: zod_1.z.string(), // "Águas Claras", "Brasília", etc.
    table: zod_1.z.string().optional(),
    reservationDate: zod_1.z.string(), // ISO "2025-10-07T20:00:00-03:00"
    notes: zod_1.z.string().optional(),
    checkinUrl: zod_1.z.string().url(), // link a ser codificado no QR
});
function buildHtml(ticket, qrCid) {
